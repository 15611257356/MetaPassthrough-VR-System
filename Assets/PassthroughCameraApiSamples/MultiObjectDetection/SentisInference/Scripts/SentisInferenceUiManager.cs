...
namespace PassthroughCameraSamples.MultiObjectDetection
{
    ...
    public class SentisInferenceUiManager : MonoBehaviour
    {
        ...
        private bool isDisplayHidden = false;
        ...
        private void Update()
        {
            ...
            {
                isDetectionPaused = true;
                ClearAnnotations();               // clean detecting quad
                m_detectionCanvas.HideMarkers();  // clean Markers
            }
        ...
        {
            if (!isDisplayHidden) m_displayImage.texture = image;
        ...
        {
            if (isDetectionPaused || isDisplayHidden)
            {
                ClearAnnotations();
                OnObjectsDetected?.Invoke(0);
                return;
        ...
        internal void DrawBox() => throw new System.NotImplementedException();
    }
}